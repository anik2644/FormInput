...
class LifeComparison extends StatefulWidget {
  const LifeComparison({super.key});

  @override
  State<LifeComparison> createState() => _LifeComparisonState();
}

class _LifeComparisonState extends State<LifeComparison> {
