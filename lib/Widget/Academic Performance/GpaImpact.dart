...
class GpaImpact extends StatefulWidget {
  const GpaImpact({super.key});

  @override
  State<GpaImpact> createState() => _GpaImpactState();
}

class _GpaImpactState extends State<GpaImpact> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Has your GPA been negatively impacted by social networking site addiction?',
